...
export default function Clients() {
  ...
  return (
    <div className="w-full flex flex-col items-center lg:items-start">
      ...
      <div className="flex flex-col items-center lg:items-start text-center lg:text-left opacity-100 mb-6 sm:mb-8 lg:mb-10 gap-3 sm:gap-4 w-full">
      ...
      <div className="flex flex-col items-center lg:items-start opacity-100 w-full">
