        ...
        <div className="absolute left-0 top-0 bottom-0 flex z-[5]">
          {leftStacks.map((stack, idx) => (
            <button
              ...
              >
                <h4 className=" sm:text-lg md:text-xl lg:text-2xl font-bold text-[#1F2024] font-heading tracking-tight leading-none font-satoshi  whitespace-nowrap transform rotate-180">
                  {stack.title}
                </h4>
              </div>
            </button>
